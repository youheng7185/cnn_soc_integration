...
module cv32e40p_librelane_top (
    ...
    assign instr_mem_axi_arready = 1'b0;
    assign instr_mem_axi_rvalid  = 1'b0;
    assign instr_mem_axi_rdata   = 32'b0;
    assign instr_mem_axi_rresp   = 2'b10; // SLVERR since read not supported
