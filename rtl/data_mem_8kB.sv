module data_mem_8kB (
    ...
    // 8kB of data mem = 2048 words
    logic [31:0] data_mem [0:2047];
    logic [31:0] rdata_q;
    logic req_q;  // Register the request for rvalid generation
    ...
    always_ff @(posedge clk_core or negedge rst_core_n) begin
        if (!rst_core_n) begin
            ...
            // Register the request to generate rvalid next cycle
            req_q <= dmem_req_i;
            dmem_rvalid_o <= req_q;  // Valid comes one cycle after request
